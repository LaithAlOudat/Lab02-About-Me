...
alert('Hey! .. nice to meet you ' + name1);
...
function ageq1() {
  if ((age.toLocaleLowerCase() === 'y') || (age.toLocaleLowerCase() === 'yes')) {
    console.log('Thats right answer');
    alert('Thats right!');
    userScore++;
  }
  else {
    ...
    alert('No No! Wrong answer. My age is 30, really!!');
  }
}
ageq1();
/*
...
function jobq2() {
  if ((job.toLocaleLowerCase() === 'y') || (job.toLocaleLowerCase() === 'yes')) {
    ...
    console.log('wrong answer.');
    alert('No No! Wrong answer. I am ... i guess! xD');
  }
}
jobq2();
/*
...
*/
let field = prompt('Am I like Computers, Data science and, A.I. ? y=yes/n=no');
...
*/
let hoppy = prompt('Am I like weight lefting fitness sport? y=yes/n=no');
...
function hoppyq4() {
  if ((hoppy.toLocaleLowerCase() === 'y') || (hoppy.toLocaleLowerCase() === 'yes')) {
    ...
    console.log('Wrong answer.');
    alert('No No! Wrong answer. I love WEIGHT LIFTING');
  }
}
hoppyq4();
/*
...
*/
let food = prompt('Is my favorite food is Shawarma? y=yes/n=no');
...
function foodq5() {
  if ((food.toLocaleLowerCase() === 'y') || (food.toLocaleLowerCase() === 'yes')) {
    ...
    console.log('Wrong answer.');
    alert('No No! Wrong answer. I love Shawarma');
  }
}
foodq5();
/*
...
function guessq6() {
  while (a > 0) {
    ...
    if (guess === rightAnswer) {
      ...
      alert('Unfortunately :( too high');
    } else {
      alert('Unfortunately :( too low');
    }
    a--;
...
*/
let a2 = 6;
let favMovies = ['Limitless', 'Interstellar', 'Ruhs Hour', 'The Martian'];
